...
alter table user add constraint fk_user_storeCategory_15 foreign key (store_category_id) references main_category (id) on delete restrict on update restrict;
create index ix_user_storeCategory_15 on user (store_category_id);
