...
public class FAQControllerTest extends WithApplication{
	...
	/**
	 * Test creates one FAQ, checks if FAQ with that id exists,
	 * and checks if question and answer are correct.
	 */
	...
	/**
	 * Test creates one FAQ, checks if FAQ with that id exists,
	 * and puts default values. After that, test checks if values are correct.
	 */
	...
	/**
	 * Test creates one FAQ, checks if FAQ with that id exists,
	 * and puts values using setters. 
	 * After that, test checks if values are correct.
	 */
	...
	/**
	 * Test creates one FAQ, checks if FAQ with that id exists,
	 * and deletes FAQ. After that, test checks if deleted FAQ is null.
	 */
